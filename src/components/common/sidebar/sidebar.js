...
import { FaRoute,FaSimCard } from "react-icons/fa";
        ...
        <div className='sidebar' style={{ width: isopen ? "220px" : "60px", flex: isopen ? 0.1 : 0.3 }}>
          <div className='top-menu'>
            ...
            <div className='showDivReport'>
              <div className='text-white p-2 pl-4 navlink' onClick={() => handleClick('inventory')} >
                ...
                <div className='sidebarsubmenu_title text-white ml-3 font-weight-bolder' > Inventory Dashboard </div>

              </div>
              <Divider />
              <div className='text-white p-2 pl-4 navlink' onClick={() => handleClick('inventory?type=sim')} >

                <div className='sidesubmenu_icon' style={{ width: '20px' }}>
                  {/* <img style={{ opacity: window.location.search.split("?")[1] == 'type=Summary' ? 1 : 0.5 }} src={SummaryIcon} alt='route' /> */}
                  <MdOutlineSimCard />
                </div>
                <div className='sidebarsubmenu_title text-white ml-3 font-weight-bolder' > Sim Inventory </div>

              </div>
              <Divider />

              <div className='text-white p-2 pl-4 navlink' onClick={() => handleClick('inventory?type=device')}>
                <div className='sidesubmenu_icon' style={{ width: '20px' }}>
                  {/* <img style={{ opacity: window.location.search.split("?")[1] == 'type=running' ? 1 : 0.5 }} src={RunningIcon} alt='route' /> */}
                  <TbReportAnalytics />
                </div>
                <div className='sidebarsubmenu_title text-white ml-3 font-weight-bolder' > Device Inventory  </div>

              </div>
              <Divider />
              <div className='text-white p-2 pl-4 navlink' onClick={() => handleClick('inventory?type=simwithdevice')} >
                <div className='sidesubmenu_icon' style={{ width: '20px' }}>
                  {/* <img style={{ opacity: window.location.search.split("?")[1] == 'type=overspeed' ? 1 : 0.5 }} src={OverSpeedIcon} alt='route' /> */}
                  <TbReportAnalytics />
                </div>
                <div className='sidebarsubmenu_title text-white ml-3 font-weight-bolder' > Sim Assigned to Device  </div>
              </div>
              <Divider />

              <div className='text-white p-2 pl-4 navlink' onClick={() => handleClick('inventory?type=vehicle')}>
                <div className='sidesubmenu_icon' style={{ width: '20px' }}>
                  {/* <img style={{ opacity: window.location.search.split("?")[1] == 'type=running' ? 1 : 0.5 }} src={RunningIcon} alt='route' /> */}
                  <TbReportAnalytics />
                </div>
                <div className='sidebarsubmenu_title text-white ml-3 font-weight-bolder' > Vehicle Inventory  </div>

              </div>
              <Divider />


              <div className='text-white p-2 pl-4 navlink' onClick={() => handleClick('inventory?type=transport')}>
                <div className='sidesubmenu_icon' style={{ width: '20px' }}>
                  {/* <img style={{ opacity: window.location.search.split("?")[1] == 'type=running' ? 1 : 0.5 }} src={RunningIcon} alt='route' /> */}
                  <TbReportAnalytics />
                </div>
                <div className='sidebarsubmenu_title text-white ml-3 font-weight-bolder' > Transporter Inventory  </div>
              ...
              <div className='text-white p-2 pl-4 navlink' onClick={() => handleClick('inventory?type=transport')}>
                ...
                <div className='sidebarsubmenu_title text-white ml-3 font-weight-bolder' > Installation Approval  </div>
